...
| C-x 4 1                           | same window prefix for next command                   |
| C-x 4 4                           | other window prefix for next command                  |
|                                   |                                                       |
| *HELP*                            |                                                       |
...
| C-v                               | scroll down                                           |
| M-v                               | scroll up                                             |
| M-n/p                             | scroll down/up without moving point                   |
...
| M-<SPC>                           | cycles delete all but one space around point          |
...
| M-%                               | replace                                               |
| C-M-%                             | regex replace                                         |
| M-s o                             | run occur on search input                             |
| M-s h l                           | highlight matching lines                              |
| M-s h r                           | highlight matching input                              |
|                                   |                                                       |
| *OCCUR*                           |                                                       |
...
| C-c C-k                           | show branches (subheadings)                           |
|                                   |                                                       |
| *ORG TODO*                        |                                                       |
...
| > /dev/kill                       | redirect output to kill ring                          |
| C-c M-b                           | prompt for buffer and insert as text                  |
| > #<buffer *scratch*>             | redirect output to buffer                             |
|                                   |                                                       |
| *VERSION CONTROL*                 |                                                       |
| C-x v d                           | status                                                |
